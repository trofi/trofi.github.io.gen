...
12 June: `cvise` [unstable tarball](https://github.com/marxin/cvise/pull/506)
...
27 Feb: `man-pages` bug: [`Makefile` failed to escape `#` properly](https://lore.kernel.org/linux-man/20250227092142.1822609-1-slyich@gmail.com/)
